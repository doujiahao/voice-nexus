...
QJ-Boot · Qianjing Java Web Scaffold
===============

> Internal unified Java Web scaffold of Qianjing Technology, customized based on JeecgBoot.  
> ⚠️ All company Java Web projects must be built on this scaffold.
...
[![](https://img.shields.io/badge/Maintained%20by-Qianjing%20Tech-orange.svg)]()
[![](https://img.shields.io/badge/stack-SpringBoot3%20%2B%20Vue3-brightgreen.svg)]()

Project introduction
-----------------------------------

<h3 align="center">Qianjing Technology · Unified Java Web Scaffold</h3>

**QJ-Boot** is the internal unified Java Web scaffold of Qianjing Technology, customized from JeecgBoot.

**Tech Stack**: Spring Boot 3 + Vue 3 + MyBatis-Plus + Ant Design Vue  
**Architecture**: Front-end/Back-end separation, Maven multi-module backend, Vite + Vue3 frontend  
**Core Features**: Low-code online forms, code generator, permission system (Shiro + JWT), workflow, reporting
